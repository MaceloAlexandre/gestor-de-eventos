from Eventos import cadastrar_evento, buscar_evento, listar_eventos, remover_evento, participar_evento, \
    cancelar_inscricao, listar_participantes, verificar_valor_arrecadao, doar_para_evento
